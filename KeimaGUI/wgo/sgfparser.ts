...
namespace WGo {
    ...
    export namespace SGF {
        ...
        function sgf_player_info(type, black, kifu: Kifu, node, value, ident) {
        ...
        // Move properties
        properties["B"] = properties["W"] = function (kifu: Kifu, node, value, ident) {
        ...
        properties["BR"] = properties["WR"] = sgf_player_info.bind(null, "rank", "BR");
        properties["PB"] = properties["PW"] = sgf_player_info.bind(null, "name", "PB");
        properties["BT"] = properties["WT"] = sgf_player_info.bind(null, "team", "BT");
        ...
        export function parse(str: string) {
            ...
            let sequence = str.match(reg_seq);
            ...
            for (var i in sequence) {
                ...
                if (sequence[i] == "(") {
                    ...
                    for (var j in props) {
                        ...
                        if (properties[ident])
                            properties[ident](kifu, node, vals, ident);
                        else {
