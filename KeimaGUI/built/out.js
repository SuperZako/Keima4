...
(function (JGO) {
    ...
    class Board {
         ...
         */
        getCoordinate(s) {
            return new JGO.Coordinate(JGO.COORDINATES.indexOf(s.toUpperCase().substr(0, 1)), this.height - parseInt(s.substr(1)));
        }
        /**
...
/*document.onload = () => */
{
    ...
    var ko = undefined, lastMove; // ko coordinate and last move coordinate
